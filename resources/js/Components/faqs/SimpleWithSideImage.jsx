...
const Column = tw.div``;
const ColumnImage = tw(Column)`hidden lg:block w-5/12 flex-shrink-0`;
...
export default ({
  ...
  imageSrc = "https://multimedia.beritajakarta.id/photo/potret_jakarta/378dc8224458e58d594436b6e6baac66.jpg",
  imageContain = false,
  imageShadow = true,
  faqs = null
}) => {
